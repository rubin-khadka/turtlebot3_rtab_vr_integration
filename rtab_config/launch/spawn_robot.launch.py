...
def generate_launch_description():
    ...
    gz_image_bridge_node = Node(
        ...
        parameters=[
            {'use_sim_time': LaunchConfiguration('use_sim_time'),
            'image.transport': 'raw'},  # Use raw transport instead of compressed
        ],
    )
    ...
    gz_depth_image_bridge_node = Node(
        ...
        parameters=[
            {'use_sim_time': LaunchConfiguration('use_sim_time'),
            'depth_image.transport': 'raw'},  # Use raw transport to avoid compression errors
        ],
    )
    ...
    launchDescriptionObject.add_action(gz_depth_image_bridge_node)  # NEW: Depth image bridge
    launchDescriptionObject.add_action(relay_camera_info_node)
    launchDescriptionObject.add_action(robot_state_publisher_node)
    launchDescriptionObject.add_action(ekf_node)
    # launchDescriptionObject.add_action(rviz_node)  # Uncommented to enable RViz
